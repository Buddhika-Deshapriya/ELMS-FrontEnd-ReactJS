...
export default function CashReleaseList() {

    const [cashRelease, setCashRelease] = useState([]);

    const fetchData = async () => {
        axios.get(`${baseUrl}/directorresponse/list`)
            .then(response => {
                console.log('response', response);
                setCashRelease(response.data);
            })
            .catch(_errors => {
                if (_errors.response) {
    ...
    return (
        <AppTemplate>
            <div className="to-cash-release-list">
